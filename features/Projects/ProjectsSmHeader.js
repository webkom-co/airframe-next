        ...
        <div className="d-flex flex-column flex-md-row mb-3 mb-md-0">
            ...
            <ButtonToolbar>
                <ButtonGroup className="mr-auto mr-md-2">
                    <Button tag={ ActiveLink } to={ `${ props.linkList }` } color="secondary" outline className="align-self-center" id="tooltipShowList">
                        <i className="fa-fw fa fa-bars"></i>
                    </Button>
                    <UncontrolledTooltip placement="bottom" target="tooltipShowList">
                        Show List
                    </UncontrolledTooltip>
                    <Button tag={ ActiveLink } to={ `${ props.linkGrid }` } color="secondary" outline className="align-self-center" id="tooltipShowGrid">
                    ...
                    <UncontrolledTooltip placement="bottom" target="tooltipShowGrid">
                    ...
                    </UncontrolledTooltip>
                        {
                            props.btnShowKanban && (
                                <React.Fragment>
                                    <Button tag={ ActiveLink } to={ `${ props.linkKanban }` } color="secondary" outline className="align-self-center" id="tooltipShowKanban">
