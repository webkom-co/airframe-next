        ...
        <Container>
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file" aria-hidden="true"></i> file</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-archive-o" aria-hidden="true"></i> file-archive-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-audio-o" aria-hidden="true"></i> file-audio-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-code-o" aria-hidden="true"></i> file-code-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-excel-o" aria-hidden="true"></i> file-excel-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-image-o" aria-hidden="true"></i> file-image-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-movie-o" aria-hidden="true"></i> file-movie-o <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-o" aria-hidden="true"></i> file-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-pdf-o" aria-hidden="true"></i> file-pdf-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-photo-o" aria-hidden="true"></i> file-photo-o <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-picture-o" aria-hidden="true"></i> file-picture-o <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-powerpoint-o" aria-hidden="true"></i> file-powerpoint-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-sound-o" aria-hidden="true"></i> file-sound-o <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-text" aria-hidden="true"></i> file-text</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-text-o" aria-hidden="true"></i> file-text-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-video-o" aria-hidden="true"></i> file-video-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-word-o" aria-hidden="true"></i> file-word-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-zip-o" aria-hidden="true"></i> file-zip-o <span className="text-muted">(alias)</span></div>
                    </Row>
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-amex" aria-hidden="true"></i> cc-amex</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-diners-club" aria-hidden="true"></i> cc-diners-club</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-discover" aria-hidden="true"></i> cc-discover</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-jcb" aria-hidden="true"></i> cc-jcb</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-mastercard" aria-hidden="true"></i> cc-mastercard</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-paypal" aria-hidden="true"></i> cc-paypal</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-stripe" aria-hidden="true"></i> cc-stripe</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-visa" aria-hidden="true"></i> cc-visa</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-credit-card" aria-hidden="true"></i> credit-card</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-credit-card-alt" aria-hidden="true"></i> credit-card-alt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-google-wallet" aria-hidden="true"></i> google-wallet</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-paypal" aria-hidden="true"></i> paypal</div>
                    </Row>
                </CardBody>
            </Card>
            { /* END Card */}
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-bitcoin" aria-hidden="true"></i> bitcoin <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-btc" aria-hidden="true"></i> btc</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cny" aria-hidden="true"></i> cny <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-dollar" aria-hidden="true"></i> dollar <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-eur" aria-hidden="true"></i> eur</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-euro" aria-hidden="true"></i> euro <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-gbp" aria-hidden="true"></i> gbp</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-gg" aria-hidden="true"></i> gg</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-gg-circle" aria-hidden="true"></i> gg-circle</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-ils" aria-hidden="true"></i> ils</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-inr" aria-hidden="true"></i> inr</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-jpy" aria-hidden="true"></i> jpy</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-krw" aria-hidden="true"></i> krw</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-money" aria-hidden="true"></i> money</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-rmb" aria-hidden="true"></i> rmb <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-rouble" aria-hidden="true"></i> rouble <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-rub" aria-hidden="true"></i> rub</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-ruble" aria-hidden="true"></i> ruble <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-rupee" aria-hidden="true"></i> rupee <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-shekel" aria-hidden="true"></i> shekel <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-sheqel" aria-hidden="true"></i> sheqel <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-try" aria-hidden="true"></i> try</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-turkish-lira" aria-hidden="true"></i> turkish-lira <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-usd" aria-hidden="true"></i> usd</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-won" aria-hidden="true"></i> won <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-yen" aria-hidden="true"></i> yen <span className="text-muted">(alias)</span></div>
                    </Row>
                </CardBody>
            </Card>
            { /* END Card */}
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-align-center" aria-hidden="true"></i> align-center</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-align-justify" aria-hidden="true"></i> align-justify</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-align-left" aria-hidden="true"></i> align-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-align-right" aria-hidden="true"></i> align-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-bold" aria-hidden="true"></i> bold</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chain" aria-hidden="true"></i> chain <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chain-broken" aria-hidden="true"></i> chain-broken</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-clipboard" aria-hidden="true"></i> clipboard</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-columns" aria-hidden="true"></i> columns</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-copy" aria-hidden="true"></i> copy <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cut" aria-hidden="true"></i> cut <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-dedent" aria-hidden="true"></i> dedent <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-eraser" aria-hidden="true"></i> eraser</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file" aria-hidden="true"></i> file</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-o" aria-hidden="true"></i> file-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-text" aria-hidden="true"></i> file-text</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-file-text-o" aria-hidden="true"></i> file-text-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-files-o" aria-hidden="true"></i> files-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-floppy-o" aria-hidden="true"></i> floppy-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-font" aria-hidden="true"></i> font</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-header" aria-hidden="true"></i> header</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-indent" aria-hidden="true"></i> indent</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-italic" aria-hidden="true"></i> italic</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-link" aria-hidden="true"></i> link</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-list" aria-hidden="true"></i> list</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-list-alt" aria-hidden="true"></i> list-alt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-list-ol" aria-hidden="true"></i> list-ol</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-list-ul" aria-hidden="true"></i> list-ul</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-outdent" aria-hidden="true"></i> outdent</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-paperclip" aria-hidden="true"></i> paperclip</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-paragraph" aria-hidden="true"></i> paragraph</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-paste" aria-hidden="true"></i> paste <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-repeat" aria-hidden="true"></i> repeat</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-rotate-left" aria-hidden="true"></i> rotate-left <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-rotate-right" aria-hidden="true"></i> rotate-right <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-save" aria-hidden="true"></i> save <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-scissors" aria-hidden="true"></i> scissors</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-strikethrough" aria-hidden="true"></i> strikethrough</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-subscript" aria-hidden="true"></i> subscript</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-superscript" aria-hidden="true"></i> superscript</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-table" aria-hidden="true"></i> table</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-text-height" aria-hidden="true"></i> text-height</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-text-width" aria-hidden="true"></i> text-width</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-th" aria-hidden="true"></i> th</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-th-large" aria-hidden="true"></i> th-large</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-th-list" aria-hidden="true"></i> th-list</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-underline" aria-hidden="true"></i> underline</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-undo" aria-hidden="true"></i> undo</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-unlink" aria-hidden="true"></i> unlink <span className="text-muted">(alias)</span></div>
                    </Row>
                </CardBody>
            </Card>
            { /* END Card */}
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-double-down" aria-hidden="true"></i> angle-double-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-double-left" aria-hidden="true"></i> angle-double-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-double-right" aria-hidden="true"></i> angle-double-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-double-up" aria-hidden="true"></i> angle-double-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-down" aria-hidden="true"></i> angle-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-left" aria-hidden="true"></i> angle-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-right" aria-hidden="true"></i> angle-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angle-up" aria-hidden="true"></i> angle-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-down" aria-hidden="true"></i> arrow-circle-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-left" aria-hidden="true"></i> arrow-circle-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-o-down" aria-hidden="true"></i> arrow-circle-o-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-o-left" aria-hidden="true"></i> arrow-circle-o-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-o-right" aria-hidden="true"></i> arrow-circle-o-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-o-up" aria-hidden="true"></i> arrow-circle-o-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-right" aria-hidden="true"></i> arrow-circle-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-circle-up" aria-hidden="true"></i> arrow-circle-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-down" aria-hidden="true"></i> arrow-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-left" aria-hidden="true"></i> arrow-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-right" aria-hidden="true"></i> arrow-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrow-up" aria-hidden="true"></i> arrow-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrows" aria-hidden="true"></i> arrows</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrows-alt" aria-hidden="true"></i> arrows-alt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrows-h" aria-hidden="true"></i> arrows-h</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrows-v" aria-hidden="true"></i> arrows-v</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-down" aria-hidden="true"></i> caret-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-left" aria-hidden="true"></i> caret-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-right" aria-hidden="true"></i> caret-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-square-o-down" aria-hidden="true"></i> caret-square-o-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-square-o-left" aria-hidden="true"></i> caret-square-o-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-square-o-right" aria-hidden="true"></i> caret-square-o-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-square-o-up" aria-hidden="true"></i> caret-square-o-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-caret-up" aria-hidden="true"></i> caret-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-circle-down" aria-hidden="true"></i> chevron-circle-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-circle-left" aria-hidden="true"></i> chevron-circle-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-circle-right" aria-hidden="true"></i> chevron-circle-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-circle-up" aria-hidden="true"></i> chevron-circle-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-down" aria-hidden="true"></i> chevron-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-left" aria-hidden="true"></i> chevron-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-right" aria-hidden="true"></i> chevron-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chevron-up" aria-hidden="true"></i> chevron-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-exchange" aria-hidden="true"></i> exchange</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-o-down" aria-hidden="true"></i> hand-o-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-o-left" aria-hidden="true"></i> hand-o-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-o-right" aria-hidden="true"></i> hand-o-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-hand-o-up" aria-hidden="true"></i> hand-o-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-long-arrow-down" aria-hidden="true"></i> long-arrow-down</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-long-arrow-left" aria-hidden="true"></i> long-arrow-left</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-long-arrow-right" aria-hidden="true"></i> long-arrow-right</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-long-arrow-up" aria-hidden="true"></i> long-arrow-up</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-toggle-down" aria-hidden="true"></i> toggle-down <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-toggle-left" aria-hidden="true"></i> toggle-left <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-toggle-right" aria-hidden="true"></i> toggle-right <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-toggle-up" aria-hidden="true"></i> toggle-up <span className="text-muted">(alias)</span></div>
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-arrows-alt" aria-hidden="true"></i> arrows-alt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-backward" aria-hidden="true"></i> backward</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-compress" aria-hidden="true"></i> compress</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-eject" aria-hidden="true"></i> eject</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-expand" aria-hidden="true"></i> expand</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-fast-backward" aria-hidden="true"></i> fast-backward</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-fast-forward" aria-hidden="true"></i> fast-forward</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-forward" aria-hidden="true"></i> forward</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pause" aria-hidden="true"></i> pause</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pause-circle" aria-hidden="true"></i> pause-circle</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pause-circle-o" aria-hidden="true"></i> pause-circle-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-play" aria-hidden="true"></i> play</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-play-circle" aria-hidden="true"></i> play-circle</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-play-circle-o" aria-hidden="true"></i> play-circle-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-random" aria-hidden="true"></i> random</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-step-backward" aria-hidden="true"></i> step-backward</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-step-forward" aria-hidden="true"></i> step-forward</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-stop" aria-hidden="true"></i> stop</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-stop-circle" aria-hidden="true"></i> stop-circle</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-stop-circle-o" aria-hidden="true"></i> stop-circle-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-youtube-play" aria-hidden="true"></i> youtube-play</div>
                    </Row>
                </CardBody>
            </Card>
            { /* END Card */}
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list margin-bottom-lg">
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-500px" aria-hidden="true"></i> 500px</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-adn" aria-hidden="true"></i> adn</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-amazon" aria-hidden="true"></i> amazon</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-android" aria-hidden="true"></i> android</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-angellist" aria-hidden="true"></i> angellist</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-apple" aria-hidden="true"></i> apple</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-behance" aria-hidden="true"></i> behance</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-behance-square" aria-hidden="true"></i> behance-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-bitbucket" aria-hidden="true"></i> bitbucket</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-bitbucket-square" aria-hidden="true"></i> bitbucket-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-bitcoin" aria-hidden="true"></i> bitcoin <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-black-tie" aria-hidden="true"></i> black-tie</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-bluetooth" aria-hidden="true"></i> bluetooth</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-bluetooth-b" aria-hidden="true"></i> bluetooth-b</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-btc" aria-hidden="true"></i> btc</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-buysellads" aria-hidden="true"></i> buysellads</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-amex" aria-hidden="true"></i> cc-amex</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-diners-club" aria-hidden="true"></i> cc-diners-club</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-discover" aria-hidden="true"></i> cc-discover</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-jcb" aria-hidden="true"></i> cc-jcb</div>
                        ...
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-stripe" aria-hidden="true"></i> cc-stripe</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-cc-visa" aria-hidden="true"></i> cc-visa</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-chrome" aria-hidden="true"></i> chrome</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-codepen" aria-hidden="true"></i> codepen</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-codiepie" aria-hidden="true"></i> codiepie</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-connectdevelop" aria-hidden="true"></i> connectdevelop</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-contao" aria-hidden="true"></i> contao</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-css3" aria-hidden="true"></i> css3</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-dashcube" aria-hidden="true"></i> dashcube</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-delicious" aria-hidden="true"></i> delicious</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-deviantart" aria-hidden="true"></i> deviantart</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-digg" aria-hidden="true"></i> digg</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-dribbble" aria-hidden="true"></i> dribbble</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-dropbox" aria-hidden="true"></i> dropbox</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-drupal" aria-hidden="true"></i> drupal</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-edge" aria-hidden="true"></i> edge</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-empire" aria-hidden="true"></i> empire</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-envira" aria-hidden="true"></i> envira</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-expeditedssl" aria-hidden="true"></i> expeditedssl</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-fa" aria-hidden="true"></i> fa <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-facebook" aria-hidden="true"></i> facebook</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-facebook-f" aria-hidden="true"></i> facebook-f <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-facebook-official" aria-hidden="true"></i> facebook-official</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-facebook-square" aria-hidden="true"></i> facebook-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-firefox" aria-hidden="true"></i> firefox</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-first-order" aria-hidden="true"></i> first-order</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-flickr" aria-hidden="true"></i> flickr</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-font-awesome" aria-hidden="true"></i> font-awesome</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-fonticons" aria-hidden="true"></i> fonticons</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-fort-awesome" aria-hidden="true"></i> fort-awesome</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-forumbee" aria-hidden="true"></i> forumbee</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-foursquare" aria-hidden="true"></i> foursquare</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-ge" aria-hidden="true"></i> ge <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-get-pocket" aria-hidden="true"></i> get-pocket</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-gg" aria-hidden="true"></i> gg</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-gg-circle" aria-hidden="true"></i> gg-circle</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-git" aria-hidden="true"></i> git</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-git-square" aria-hidden="true"></i> git-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-github" aria-hidden="true"></i> github</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-github-alt" aria-hidden="true"></i> github-alt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-github-square" aria-hidden="true"></i> github-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-gitlab" aria-hidden="true"></i> gitlab</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-gittip" aria-hidden="true"></i> gittip <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-glide" aria-hidden="true"></i> glide</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-glide-g" aria-hidden="true"></i> glide-g</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-google" aria-hidden="true"></i> google</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-google-plus" aria-hidden="true"></i> google-plus</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-google-plus-circle" aria-hidden="true"></i> google-plus-circle <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-google-plus-official" aria-hidden="true"></i> google-plus-official</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-google-plus-square" aria-hidden="true"></i> google-plus-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-google-wallet" aria-hidden="true"></i> google-wallet</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-gratipay" aria-hidden="true"></i> gratipay</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-hacker-news" aria-hidden="true"></i> hacker-news</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-houzz" aria-hidden="true"></i> houzz</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-html5" aria-hidden="true"></i> html5</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-instagram" aria-hidden="true"></i> instagram</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-internet-explorer" aria-hidden="true"></i> internet-explorer</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-ioxhost" aria-hidden="true"></i> ioxhost</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-joomla" aria-hidden="true"></i> joomla</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-jsfiddle" aria-hidden="true"></i> jsfiddle</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-lastfm" aria-hidden="true"></i> lastfm</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-lastfm-square" aria-hidden="true"></i> lastfm-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-leanpub" aria-hidden="true"></i> leanpub</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-linkedin" aria-hidden="true"></i> linkedin</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-linkedin-square" aria-hidden="true"></i> linkedin-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-linux" aria-hidden="true"></i> linux</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-maxcdn" aria-hidden="true"></i> maxcdn</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-meanpath" aria-hidden="true"></i> meanpath</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-medium" aria-hidden="true"></i> medium</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-mixcloud" aria-hidden="true"></i> mixcloud</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-modx" aria-hidden="true"></i> modx</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-odnoklassniki" aria-hidden="true"></i> odnoklassniki</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-odnoklassniki-square" aria-hidden="true"></i> odnoklassniki-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-opencart" aria-hidden="true"></i> opencart</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-openid" aria-hidden="true"></i> openid</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-opera" aria-hidden="true"></i> opera</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-optin-monster" aria-hidden="true"></i> optin-monster</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pagelines" aria-hidden="true"></i> pagelines</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-paypal" aria-hidden="true"></i> paypal</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pied-piper" aria-hidden="true"></i> pied-piper</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pied-piper-alt" aria-hidden="true"></i> pied-piper-alt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pied-piper-pp" aria-hidden="true"></i> pied-piper-pp</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pinterest" aria-hidden="true"></i> pinterest</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pinterest-p" aria-hidden="true"></i> pinterest-p</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-pinterest-square" aria-hidden="true"></i> pinterest-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-product-hunt" aria-hidden="true"></i> product-hunt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-qq" aria-hidden="true"></i> qq</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-ra" aria-hidden="true"></i> ra <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-rebel" aria-hidden="true"></i> rebel</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-reddit" aria-hidden="true"></i> reddit</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-reddit-alien" aria-hidden="true"></i> reddit-alien</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-reddit-square" aria-hidden="true"></i> reddit-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-renren" aria-hidden="true"></i> renren</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-resistance" aria-hidden="true"></i> resistance <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-safari" aria-hidden="true"></i> safari</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-scribd" aria-hidden="true"></i> scribd</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-sellsy" aria-hidden="true"></i> sellsy</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-share-alt" aria-hidden="true"></i> share-alt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-share-alt-square" aria-hidden="true"></i> share-alt-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-shirtsinbulk" aria-hidden="true"></i> shirtsinbulk</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-simplybuilt" aria-hidden="true"></i> simplybuilt</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-skyatlas" aria-hidden="true"></i> skyatlas</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-skype" aria-hidden="true"></i> skype</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-slack" aria-hidden="true"></i> slack</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-slideshare" aria-hidden="true"></i> slideshare</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-snapchat" aria-hidden="true"></i> snapchat</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-snapchat-ghost" aria-hidden="true"></i> snapchat-ghost</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-snapchat-square" aria-hidden="true"></i> snapchat-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-soundcloud" aria-hidden="true"></i> soundcloud</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-spotify" aria-hidden="true"></i> spotify</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-stack-exchange" aria-hidden="true"></i> stack-exchange</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-stack-overflow" aria-hidden="true"></i> stack-overflow</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-steam" aria-hidden="true"></i> steam</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-steam-square" aria-hidden="true"></i> steam-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-stumbleupon" aria-hidden="true"></i> stumbleupon</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-stumbleupon-circle" aria-hidden="true"></i> stumbleupon-circle</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-tencent-weibo" aria-hidden="true"></i> tencent-weibo</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-themeisle" aria-hidden="true"></i> themeisle</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-trello" aria-hidden="true"></i> trello</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-tripadvisor" aria-hidden="true"></i> tripadvisor</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-tumblr" aria-hidden="true"></i> tumblr</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-tumblr-square" aria-hidden="true"></i> tumblr-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-twitch" aria-hidden="true"></i> twitch</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-twitter" aria-hidden="true"></i> twitter</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-twitter-square" aria-hidden="true"></i> twitter-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-usb" aria-hidden="true"></i> usb</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-viacoin" aria-hidden="true"></i> viacoin</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-viadeo" aria-hidden="true"></i> viadeo</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-viadeo-square" aria-hidden="true"></i> viadeo-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-vimeo" aria-hidden="true"></i> vimeo</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-vimeo-square" aria-hidden="true"></i> vimeo-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-vine" aria-hidden="true"></i> vine</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-vk" aria-hidden="true"></i> vk</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-wechat" aria-hidden="true"></i> wechat <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-weibo" aria-hidden="true"></i> weibo</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-weixin" aria-hidden="true"></i> weixin</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-whatsapp" aria-hidden="true"></i> whatsapp</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-wikipedia-w" aria-hidden="true"></i> wikipedia-w</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-windows" aria-hidden="true"></i> windows</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-wordpress" aria-hidden="true"></i> wordpress</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-wpbeginner" aria-hidden="true"></i> wpbeginner</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-wpforms" aria-hidden="true"></i> wpforms</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-xing" aria-hidden="true"></i> xing</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-xing-square" aria-hidden="true"></i> xing-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-y-combinator" aria-hidden="true"></i> y-combinator</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-y-combinator-square" aria-hidden="true"></i> y-combinator-square <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-yahoo" aria-hidden="true"></i> yahoo</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-yc" aria-hidden="true"></i> yc <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-yc-square" aria-hidden="true"></i> yc-square <span className="text-muted">(alias)</span></div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-yelp" aria-hidden="true"></i> yelp</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-yoast" aria-hidden="true"></i> yoast</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-youtube" aria-hidden="true"></i> youtube</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-youtube-play" aria-hidden="true"></i> youtube-play</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-youtube-square" aria-hidden="true"></i> youtube-square</div>
                    </Row>
                </CardBody>
            </Card>
            { /* END Card */}
            ...
            <Card className="mb-3">
                <CardBody>
                    ...
                    <Row className="fontawesome-icon-list">
                        <div className="fa-hover col-md-3 col-sm-4">Example of ambulance</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-h-square" aria-hidden="true"></i> h-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-heart" aria-hidden="true"></i> heart</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-heart-o" aria-hidden="true"></i> heart-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-heartbeat" aria-hidden="true"></i> heartbeat</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-hospital-o" aria-hidden="true"></i> hospital-o</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-medkit" aria-hidden="true"></i> medkit</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-plus-square" aria-hidden="true"></i> plus-square</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-stethoscope" aria-hidden="true"></i> stethoscope</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-user-md" aria-hidden="true"></i> user-md</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-wheelchair" aria-hidden="true"></i> wheelchair</div>
                        <div className="fa-hover col-md-3 col-sm-4"><i className="fa fa-fw fa-wheelchair-alt" aria-hidden="true"></i> wheelchair-alt</div>
                    </Row>
                </CardBody>
