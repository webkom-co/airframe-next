...
import { LayoutSidebarA } from './../../features/Layout/LayoutSidebarA';
...
const SidebarA = () => (
    <Container>
        ...
        <section className="mb-5">
            ...
            <ul className="pl-3">
                <li>
                    <Link to="/layouts/sidebar-a" className="text-primary">Sidebar A</Link>
                </li>
                <li>
...
SidebarA.layoutComponent = LayoutSidebarA;
